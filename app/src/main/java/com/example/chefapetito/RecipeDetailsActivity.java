...
import com.example.chefapetito.Adapters.IngredientsAdapter;
import com.example.chefapetito.Adapters.SimilarRecipeAdapter;
...
public class RecipeDetailsActivity extends AppCompatActivity {
    ...
    private final SimilarRecipeListener similarRecipeListener = new SimilarRecipeListener() {
        ...
        @Override
        public void didError(String message) {
            //Toast.makeText(RecipeDetailsActivity.this,"Error acquiring similar recipes",Toast.LENGTH_SHORT).show();
